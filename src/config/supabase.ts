...
if (!supabaseUrl) {
  console.warn(
    "EXPO_PUBLIC_SUPABASE_URL is not defined. Supabase client will not be initialized properly.",
  );
}

if (!supabaseAnonKey) {
  console.warn(
    "EXPO_PUBLIC_SUPABASE_ANON_KEY is not defined. Supabase client will not be initialized properly.",
  );
}
